...
### ROS Graphics
Some of the ROS components (for example rviz2, gazebo and rqt) are graphical applications. If you want to use these you should enter the command below in a command prompt running on the Raspberry Pi desktop. You should also issue the command below before you enter this command. 
```
xhost +local:
```
...
Before you start make sure that you have installed Docker and built the ROS image. Now 
